...
import { CalendlyStore } from './types';
...
// Core data selectors
export const useCalendlyConnection = (state: CalendlyStore) => state.connectionStatus;
...
export const useCalendlyAvailability = (state: CalendlyStore) => state.availabilitySchedules;
...
// UI selectors
export const useCalendlySelectedDate = (state: CalendlyStore) => state.selectedDate;
export const useCalendlyCalendarView = (state: CalendlyStore) => state.calendarView;
export const useCalendlyMeetingFilters = (state: CalendlyStore) => state.meetingFilters;
export const useCalendlySelectedMeetings = (state: CalendlyStore) => state.selectedMeetings;
